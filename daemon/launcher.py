...
def launch(args, log):
    ...
    if not profile.is_file():
        raise RuntimeError(
            "Engine is not configured. Run tools/configure_engine.py; see README.md."
        )
    ...
    try:
        ...
        if info.get("engine") == "Marigold V2 Normals":
            return
    ...
    print("Starting configured Marigold V2 engine", file=log, flush=True)
